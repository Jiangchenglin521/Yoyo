...
from chatbot.load_data import load_data
...
class TextData:
    ...
    def loadDataset(self, filename):
        ...
        Args:
            filename (str): pickle filename
        """
        train_path = "/mnt/omada/emotion/code/CA/chatbot/ada.txt"
        #train_path = '/home/medical/liupei/DeepQA-chinese/chatbot/chatbot.txt'
        #train_path = "/home/luojiao/litiantian/jiangchenglin/yo/chatbot/newxiaohuangji20w.txt"
        self.word2id, self.id2word, self.trainingSamples = load_data(train_path)
